...
from interfaces.interfaces import LLMClient, EmbeddingClient
import os
...
class OpenAIEmbeddingClient(EmbeddingClient):
    ...
    def __init__(self, credential , endpoint: str, api_version: str, model: str):
        ...
        self._client = AzureOpenAI(api_key=credential, api_version=api_version, azure_endpoint=endpoint)
        self._model = model
    ...
    def from_env(cls, prefix: str = "AZURE_OPENAI_") -> "Self":
        ...
        return cls(credential=credential, endpoint=endpoint, api_version=api_version, model=model)